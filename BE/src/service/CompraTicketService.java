...
public class CompraTicketService {
	...
	/*
	 * public CompraTicket getById(int id) throws Exception { return
	 * compraTicketRepository.getById(id); }
	 * 
	 * public ArrayList<CompraTicket> getAll() throws Exception { return
	 * compraTicketRepository.getAll(); }
	 */
