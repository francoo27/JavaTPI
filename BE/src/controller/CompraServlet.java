...
public class CompraServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Ticket> tickets = mapTickets(compraDTO.getPrecioIdQuantitySelected(),
				compraDTO.getAsientoIdSelected());
		...
		try {
			compraDTO.setAsientos(asientoService.getAsientosByIds(compraDTO.getAsientoIdSelected()));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	private ArrayList<Ticket> mapTickets(ArrayList<PrecioIdQuantity> precioIdQuantitySelected,
			ArrayList<Integer> asientoIdSelected) {
